...
class AltTrackerScreen extends StatefulWidget {
  final LocalFileSystem localFileSystem;

  AltTrackerScreen({localFileSystem})
      : this.localFileSystem = localFileSystem ?? LocalFileSystem();

  @override
  State<StatefulWidget> createState() => new AltTrackerScreenState();
}

class AltTrackerScreenState extends State<AltTrackerScreen> {
